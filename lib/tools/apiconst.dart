class Apiconst {
  ...
  static String addTimeTable = '${baseurl}timetable';
  static String getTimeTable = '${baseurl}timetable';
  static String updateTimeTable = '${baseurl}timetable/update';
  static String findTimeTable = '${baseurl}timetable/find';
}
